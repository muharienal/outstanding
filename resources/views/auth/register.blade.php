                ...
                <div class="p-2 mt-4">
                    <form action="{{ route('register') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="phone" name="phone" value="{{ old('phone') }}" autocomplete="phone" tabindex="2">
                            <x-form.validation.error name="phone" />
                        </div>

                        <div class="mb-3">
                            <label for="unit_kerja" class="form-label">Unit Kerja <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="unit_kerja" name="unit_kerja" value="{{ old('phone') }}" autocomplete="unit_kerja" tabindex="2">
                            <x-form.validation.error name="unit_kerja" />
                        </div>
